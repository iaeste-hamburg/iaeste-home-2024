...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"outgoingstudent"} />
		<Helmet>
			<title>
				Outgoing | IAESTE Hamburg
			</title>
			...
			<meta property={"og:title"} content={"Outgoing | IAESTE Hamburg"} />
		...
		<Components.IaesteHeader>
			...
			<Override slot="overrideOverride4" width="auto" id="menuentry">
				Outgoing
				<br />
				(for students)
			</Override>
